...
public class User implements Serializable{
	...
	@Column(length=40)
	 ...
	 private int age;//` int(11) DEFAULT NULL COMMENT '年龄',
	...
	public User(String id, String mobile, String password, String name,
			String sex, String address, String email, int age, String idCard,
			String nationality, Date birth_day, String avatar, String deviceId,
			String is_driver, String is_proerty_manager, String is_daibo,
			String is_guard_manager, String is_owner, String is_casher,
			String is_guard, String is_valid_mail, String status,
			Date date_created, Date date_updated, String auth_code,
			String idcard_front, String idcard_back, String is_admin,
			String is_operater, String parkId,
			Date driving_licence_register_date, String accid, String invideCode) {
		this.id = id;
		this.mobile = mobile;
		this.password = password;
		this.name = name;
