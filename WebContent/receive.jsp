...
<html>
  ...
  <div accept="application/msexcel" align="center" id="main">
		...
		<form action="#" method="get" style="alignment-baseline:auto;width: auto;height: auto;">
			<div accept="application/msexcel" class="ey" align="center">
				<div id="tag" ccept="application/msexcel">
				<input type="text" id="red"  value="${cony}" readonly="readonly" />
				<input type="text" id="time"  value="${fn:substring(sharecreate,0,10)}至${fn:substring(shareend,0,10)}" readonly="readonly" />
				<input type="text" id="mobile"  value="限尾号${fn:substring(sharemobile,7,11)}的手机号使用" readonly="readonly" />
				</div>
